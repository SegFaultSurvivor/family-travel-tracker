...
- 🌟 **Tech Stack**: Node.js, Express.js, EJS, PostgreSQL  
- 🗺 **Interactive World Map** – Select and mark visited locations  
- 👨‍👩‍👧‍👦 **Family Travel Logging** – Track travel history for all family members
